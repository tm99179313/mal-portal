      ...
      messages: [
        {
          role: 'system',
          content:
            'あなたはMake A Line Plusの受講者向けAIアシスタントです。与えられたセミナー資料の抜粋だけを根拠に、歯科医師にとって実用的でわかりやすい日本語で回答してください。資料にない内容は断定せず、「資料内では確認できません」と伝えてください。医療判断は最終的に担当歯科医師が行う前提で、断定的な治療指示は避けてください。回答の最後に、参照した回・ページを箇条書きで示してください。',
        },
        {
          role: 'user',
          content: [
            '以下の資料抜粋をもとに質問へ回答してください。',
            '',
            '【質問】',
            question,
            '',
